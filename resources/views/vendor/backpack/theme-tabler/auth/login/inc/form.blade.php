...
<a href="{{ url(trim((string) config('backpack.base.route_prefix', 'admin'), '/').'/auth/google/redirect') }}" class="btn btn-outline-secondary w-100 d-flex align-items-center justify-content-center gap-2">
